...
//when the hero button is clicked call the set number of images from the api site defined by the limit and cycle through each and add attributes to the img and get the rating
    	 ...
    	 .done(function(response) {
	     	...
	     	for (var i = 0; i < response.data.length; i++) {
				...
				//append the images to the page
				 ...
				 $("#heros").append(ratingDIV);
				 //append the rating to the images
